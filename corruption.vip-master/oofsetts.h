...
struct COffsetz
{
	...
	struct
	{
		...
		std::ptrdiff_t m_flSimulationTime;//shouldnt this go to the actual offset? its tarded maybe i fucked something? i mean it may happen thats something with netvar manager
		std::ptrdiff_t m_nSequence;
		std::ptrdiff_t m_vAbsOrigin;
