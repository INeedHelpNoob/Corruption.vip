...
public:
	...
	CInput::CUserCmd *GetUserCmd1(int slot, int seq)
	{
...
struct Ray_t1
{
	...
	Ray_t1() : m_pWorldAxisTransform(NULL) {}
...
public:
	...
	void TraceRay1(const Ray_t1 &ray, unsigned int fMask, ITraceFilter* pTraceFilter, trace_t* pTrace)
	{
		typedef void(__thiscall* fnTraceRay1)(void*, const Ray_t1&, unsigned int, ITraceFilter*, trace_t*);
		call_vfunc<fnTraceRay1>(this, 5)(this, ray, fMask, pTraceFilter, pTrace);
	}
	/*CAUSES A CRASH*/
	...
	}//FUCKING HELL EDGING CRASHES TOO?
	/*CAUSES A CRASH*/

	void BestPointX(IClientEntity *targetPlayer, Vector &final, bool negative, float pointscale)
	{
		trace_t tr;
		Ray_t ray;
	...
	void BestPointY(IClientEntity *targetPlayer, Vector &final, bool negative, float pointscale)
	{
		trace_t tr;
		Ray_t ray;
		CTraceCBaseEntity* filter = new CTraceCBaseEntity();
	...
	void BestPointZ(IClientEntity *targetPlayer, Vector &final, bool negative, float pointscale)
	{
		trace_t tr;
		Ray_t ray;
		CTraceCBaseEntity* filter = new CTraceCBaseEntity();
